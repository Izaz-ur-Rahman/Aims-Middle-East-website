...
const Projects = () => {
  ...
  return (
    <section id="projects" ref={sectionRef} className="py-16 mt-[-80px] lg:py-32  bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16 mt-[40px]">
          <h2 className="text-3xl sm:text-4xl lg:text-6xl mt-[-90px] font-bold mb-4 sm:mb-6 animate-on-scroll opacity-0">
